...
import com.mapp.mathquiz.activities.AchievementsActivity;
import com.mapp.mathquiz.activities.StartGameActivity;
    ...
    private void showDialogAbout()
    {
        ...
        ((Button) dialog.findViewById(R.id.bt_privacy)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri uri = Uri.parse("https://doc-hosting.flycricket.io/maths-quiz-privacy-policy/e874883a-2727-4553-b1a9-c366a6be920f/privacy");
